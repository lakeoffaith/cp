    ...
    render(){
        ...
        return(
            <MaterialToolbar
                ...
                actions={navigator? (navigator.currentRoute?(navigator.currentRoute.actionsArray?this.getArray(navigator.currentRoute.actionsArray):null):this.getArray([{icon: 'warning',badge:{value:4,animate:true},onPressRoute:'UserCenter'}])):null}
                rightIconStyle={{
                    margin: 10
                }}
            />
